...
<ul>
	<li>
		<?php echo lang('in_complete_visit') ?> <a href="<?php echo preg_replace('{install/$}', '', base_url()) .'admin' ?>"><?php echo lang('in_admin_area') ?></a>
	</li>
	<li><?php echo lang('in_complete_visit') ?> <a href="<?php echo preg_replace('{install/$}', '', base_url()) ?>"><?php echo lang('in_site_front') ?></a></li>
