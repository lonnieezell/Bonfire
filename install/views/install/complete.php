...
<ul>
	<li><?php echo lang('in_complete_visit') ?> <a href="/admin"><?php echo lang('in_admin_area') ?></a></li>
	<li><?php echo lang('in_complete_visit') ?> <a href="/"><?php echo lang('in_site_front') ?></a></li>
