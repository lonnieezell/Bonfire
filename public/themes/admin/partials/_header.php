...
<head>
	...
	<script src="<?php echo Template::theme_url('js/tiny_mce/tiny_mce.js'); ?>"></script>
	
	<!-- Option Theme of TinuMCE or you can put this scripts in global.js-->
	<script type="text/javascript">
	    tinyMCE.init({
	       ...
	       content_css : "<?php echo Template::theme_url('css/tinymce/content.css'); ?>"
	    });
    </script>
