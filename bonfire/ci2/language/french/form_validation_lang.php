...
$lang['alpha_numeric_spaces']  = "Le champ %s ne peut contenir que des caractères alphanumériques et des espaces.";
$lang['alpha_dash']            = "Le champ %s ne peut contenir que des caractères alphanumériques, des caractères de soulignement et des traits d'union.";
...
$lang['differs']               = "Le champ %s doit être différent du champ %s.";
...
$lang['less_than_equal_to']    = "Le champ %s doit contenir un nombre inférieur ou égal à %s.";
$lang['greater_than']          = "Le champ %s doit contenir un nombre supérieur à %s.";
$lang['greater_than_equal_to'] = "Le champ %s doit contenir un nombre supérieur ou égal à %s.";
$lang['error_message_not_set'] = "Impossible d'accéder à un message d'erreur correspondant à votre champ nommé %s.";
$lang['in_list']               = "Le champ %s doit avoir une de ces valeurs : %s.";
