	...
	<div id="header">
		...
		<div id="toolbar">
			<div id="toolbar-right">
				<?php if(isset($shortcut_data) && is_array($shortcut_data['shortcut_keys']) && count($shortcut_data['shortcut_keys'])):?><img src="/bonfire/themes/admin/images/keyboard-icon.png" id="shortkeys_show" title="Keyboard Shortcuts" alt="Keyboard Shortcuts"/><?php endif;?>
