		...
		<table class="table table-striped table-condensed">
			...
			<tbody>
				<tr>
					...
					<td>
						<input type="text" id="shortcut<?php echo $count;?>" name="shortcut<?php echo $count;?>" class="medium" value="<?php e(isset($shortcut) ? $shortcut : set_value('shortcuts['.$count.']')) ?>" />
					</td>
					<td>
				...
				<?php foreach ($settings as $action => $shortcut): ?>
					...
					<tr id="shortcut<?php echo $count; ?>">
						<td id="shortcut<?php echo $count; ?>">
							<input type="hidden" id="action<?php echo $count;?>" name="action[<?php echo $count;?>]"  value="<?php e(isset($action) ? $action : set_value('actions['.$count.']')) ?>" />
							<?php echo $current[$action]['description'] ?>
						</td>
						<td>
							<input type="text" id="shortcut<?php echo $count;?>" name="shortcut[<?php echo $count;?>]"  value="<?php e(isset($shortcut) ? $shortcut : set_value('shortcuts['.$count.']')) ?>" />
						</td>
						<td>
