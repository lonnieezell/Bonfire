...
<div class="admin-box">
	...
	<div class="tabbable">
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#main-settings" data-toggle="tab"><?php echo lang('set_t_main'); ?></a>
			</li>
			<li>
				<a href="#security" data-toggle="tab"><?php echo lang('set_t_security'); ?></a>
			</li>

			<?php if (has_permission('Site.Developer.View')) : ?>
			<li>
				<a href="#developer" data-toggle="tab"><?php echo lang('set_t_developer'); ?></a>
			</li>
			<?php endif; ?>
		</ul>
		...
		<fieldset>
			<legend><?php echo lang('set_p_main'); ?></legend>

			<div class="control-group">
				<label class="control-label" for="title"><?php echo lang('set_site_name') ?></label>
				<div class="controls">
			...
			<div class="control-group">
				<label class="control-label" for="system_email"><?php echo lang('set_site_email'); ?></label>
				<div class="controls">
					...
					<p class="help-inline"><?php echo lang('set_site_email_help'); ?></p>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<select name="status">
						...
						<option value="0" <?php echo isset($settings) && $settings['site.status'] == 0 ? 'selected="selected"' : set_select('site.status', '1') ?>><?php echo lang('set_offline'); ?></option>
					</select>
				</div>
			</div>

			<div class="control-group">
				<label class="control-label" for="list_limit"><?php echo lang('set_top_number') ?></label>
				<div class="controls">
					...
					<p class="help-inline"><?php echo lang('set_top_number_help') ?></p>
				</div>
			</div>

			<div class="control-group">
				<label class="control-label" for="status"><?php echo lang('set_languages'); ?></label>
				<div class="controls">
					...
					<p class="help-inline"><?php echo lang('set_languages_help'); ?></p>
				</div>
			</div>
		...
		<fieldset>
			<legend><?php echo lang('set_p_security'); ?></legend>
				...
				<div class="controls">
					<div class="inputs-list">
						<label>
							...
							<span><?php echo lang('set_allow_register'); ?></span>
						</label>
					</div>
				</div>
			</div>
			...
			<div class="control-group">
				<label class="control-label" for="user_activation_method"><?php echo lang('set_activate_method'); ?></label>
				<div class="controls">
					<select name="user_activation_method" id="user_activation_method">
						<option value="0" <?php echo $settings['auth.user_activation_method'] == 0 ? 'selected="selected"' : ''; ?>><?php echo lang('set_activate_none'); ?></option>
						<option value="1" <?php echo $settings['auth.user_activation_method'] == 1 ? 'selected="selected"' : ''; ?>><?php echo lang('set_activate_email'); ?></option>
						<option value="2" <?php echo $settings['auth.user_activation_method'] == 2 ? 'selected="selected"' : ''; ?>><?php echo lang('set_activate_admin'); ?></option>
					</select>
				</div>
			</div>

			<div class="control-group">
				<label class="control-label" for="login_type"><?php echo lang('set_login_type'); ?></label>
				<div class="controls">
					<select name="login_type">
						<option value="email" <?php echo $settings['auth.login_type'] == 'email' ? 'selected="selected"' : ''; ?>><?php echo lang('set_login_type_email'); ?></option>
						<option value="username" <?php echo $settings['auth.login_type'] == 'username' ? 'selected="selected"' : ''; ?>><?php echo lang('set_login_type_username'); ?></option>
						<option value="both" <?php echo $settings['auth.login_type'] == 'both' ? 'selected="selected"' : ''; ?>><?php echo lang('set_login_type_both'); ?></option>
					</select>
				</div>
			</div>

			<div class="control-group">
				<label class="control-label"><?php echo lang('set_use_usernames'); ?></label>
				<div class="controls">
					<label class="radio">
						...
						<span><?php echo lang('set_use_username'); ?></span>
					</label>
					<label class="radio">
						...
						<span><?php echo lang('set_use_email'); ?></span>
					</label>
				</div>
			</div>

			<div class="control-group">
				<label class="control-label"><?php echo lang('set_display_name'); ?></label>
				<div class="controls">
				...
				<div class="controls">
					<div class="inputs-list">
						<label class="checkbox" for="allow_remember">
							...
							<span><?php echo lang('set_allow_remember'); ?></span>
						</label>
					</div>
				</div>
			</div>
			...
			<div class="control-group" id="password-strength">
				<label class="control-label" for="password-strength"><?php echo lang('set_password_strength'); ?></label>
				<div class="controls">
					...
					<p class="help-inline"><?php echo lang('set_password_length_help'); ?></p>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<label class="checkbox" for="password_force_numbers">
						...
						<?php echo lang('set_password_force_numbers'); ?>
					</label>
					<label class="checkbox" for="password_force_symbols">
						...
						<?php echo lang('set_password_force_symbols'); ?>
					</label>
					<label class="checkbox" for="password_force_mixed_case">
						...
						<?php echo lang('set_password_force_mixed_case'); ?>
					</label>
					<label class="checkbox" for="password_show_labels">
							...
							<?php echo lang('set_password_show_labels'); ?>
					</label>
				</div>
			</div>
	...
	<div class="tab-pane" id="developer">
		<!-- Developer Settings -->
		<fieldset>
			<legend><?php echo lang('set_p_developer'); ?></legend>
			...
			<label class="control-label" >&nbsp;</label>
				<div class="controls">
					<label class="checkbox" for="show_profiler">
						...
						<span><?php echo lang('set_show_profiler'); ?></span>
					</label>
					<label class="checkbox" for="show_front_profiler">
						...
						<span><?php echo lang('set_show_front_profiler'); ?></span>
					</label>
					<label class="checkbox" for="do_check">
						...
						<span><?php echo lang('set_do_check') ?></span>
						<p class="help-block"><?php echo lang('set_do_check_edge'); ?></p>
					</label>
					<label class="checkbox" for="bleeding_edge">
						...
						<span><?php echo lang('set_update_show_edge'); ?></span>
						<p class="help-block"><?php echo lang('set_update_info_edge'); ?></p>
					</label>
				</div>
			</div>
