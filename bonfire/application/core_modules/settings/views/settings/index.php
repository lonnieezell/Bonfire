	...
	<div class="tabbable">
		...
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="title" class="span6" value="<?php e(isset($settings['site.title']) ? $settings['site.title'] : set_value('site.title')) ?>" />
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="system_email" class="span4" value="<?php e(isset($settings['site.system_email']) ? $settings['site.system_email'] : set_value('site.system_email')) ?>" />
