<div class="admin-box">
	...
	<fieldset>
		<legend><?php echo lang('em_p_general_settings'); ?></legend>
		...
		<div class="control-group">
			...
			<div class="controls">
				<select name="mailtype">
					<option value="text" <?php echo isset($mailtype) && $mailtype == 'text' ? 'selected="selected"' : ''; ?>><?php echo lang('em_email_type_text'); ?></option>
					<option value="html" <?php echo isset($mailtype) && $mailtype == 'html' ? 'selected="selected"' : ''; ?>><?php echo lang('em_email_type_html'); ?></option>
				</select>
			</div>
		</div>
	...
	<fieldset>
		<legend><?php echo lang('em_p_email_settings'); ?></legend>
		<!-- PHP Mail -->
		...
		<div id="sendmail" class="control-group <?php echo form_error('mailpath') ? 'error' : ''; ?>" style="padding-top: 27px">
			<label  class="control-label" for="mailpath"><?php echo lang('em_sendmail_path'); ?></label>
			<div class="controls">
		...
		<div id="smtp" style="padding-top: 27px">
			...
			<div class="control-group <?php echo form_error('smtp_host') ? 'error' : ''; ?>">
				<label class="control-label" for="smtp_host"><?php echo lang('em_smtp_host'); ?></label>
				<div class="controls">
			...
			<div class="control-group">
				<label class="control-label" for="smtp_user"><?php echo lang('em_smtp_username'); ?></label>
				<div class="controls">
			...
			<div class="control-group">
				<label class="control-label" for="smtp_pass"><?php echo lang('em_smtp_password'); ?></label>
				<div class="controls">
			...
			<div class="control-group">
				<label class="control-label" for="smtp_port"><?php echo lang('em_smtp_port'); ?></label>
				<div class="controls">
			...
			<div class="control-group">
				<label class="control-label" for="smptp_timeout"><?php echo lang('em_smtp_timeout'); ?></label>
				<div class="controls">
...
<div class="admin-box">
	...
	<fieldset>
		...
		<?php echo form_open(SITE_AREA .'/settings/emailer/test', array('class' => 'form-horizontal', 'id'=>'test-form')); ?>
			...
			<br/>
			<div class="control-group">
				<label class="control-label" for="email"><?php echo lang('em_email'); ?></label>
				<div class="controls">
					<input type="email" name="test_email" id="test-email" value="<?php echo config_item('site.system_email'); ?>" />
					<input type="submit" name="submit" class="btn btn-primary" value="<?php echo lang('em_action_send_test_email'); ?>" />
				</div>
			</div>
		</fieldset>
