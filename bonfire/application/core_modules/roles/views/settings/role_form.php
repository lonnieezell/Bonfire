...
<div class="admin-box">
	...
	<fieldset>
		...
		<div class="form-actions">
			<input type="submit" name="submit" class="btn btn-primary" value="<?php echo lang('role_save_role'); ?>" /> <?php echo lang('bf_or'); ?> <?php echo anchor(SITE_AREA .'/settings/roles', lang('bf_action_cancel')); ?>
