...
<?php echo form_open($this->uri->uri_string(), array('class' => "form-horizontal", 'autocomplete' => 'off')); ?>
	...
	<div class="control-group <?php echo iif( form_error('display_name') , 'error') ;?>">
		...
		<div class="controls">
			<input class="span6" type="text" name="display_name" value="<?php e(isset($user) ? $user->display_name : set_value('display_name')) ?>" />
		</div>
	</div>
	...
	<div class="control-group <?php echo iif( form_error('email') , 'error') ;?>">
		...
		<div class="controls">
			<input class="span6" type="text" name="email" value="<?php e(isset($user) ? $user->email : set_value('email')) ?>" />
		</div>
	</div>
	...
	<div class="control-group <?php echo iif( form_error('username') , 'error') ;?>">
		...
		<div class="controls">
			<input class="span6" type="text" name="username" value="<?php e(isset($user) ? $user->username : set_value('username')) ?>" />
		</div>
	</div>
	<?php endif; ?>
