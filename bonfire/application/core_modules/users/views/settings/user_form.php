...
<div class="admin-box">
	...
	<fieldset>
		...
		<div class="control-group <?php echo form_error('password') ? 'error' : '' ?>">
			<label for="username"><?php echo lang('bf_password') ?></label>
			<div class="controls">
		...
		<div class="control-group <?php echo form_error('pass_confirm') ? 'error' : '' ?>">
			<label for="username"><?php echo lang('bf_password_confirm') ?></label>
			<div class="controls">
		...
		<div class="form-actions">
			<input type="submit" name="submit" class="btn primary" value="<?php echo lang('bf_action_save') .' '. lang('bf_user') ?> " /> <?php echo lang('bf_or') ?> <?php echo anchor(SITE_AREA .'/settings/users', lang('bf_action_cancel')); ?>
		</div>
