	...
	<table cellspacing="0">
		...
		<?php foreach ($users as $user) : ?>
			<tr>
				...
				<td class="text-right">
					<?php echo anchor('admin/settings/users/purge/'. $user->id, lang('bf_action_purge'), 'class="ajaxify"') ?> | 
					<?php echo anchor('admin/settings/users/restore/'. $user->id, lang('bf_action_restore'), 'class="ajaxify"') ?>
				</td>
			</tr>
		<?php endforeach; ?>
		</tbody>
...
<div class="notification information">
	<p><?php echo lang('us_no_deleted'); ?> <?php echo anchor('admin/settings/users', lang('bf_go_back')) ?></p>
</div>
<?php endif; ?>