...
<div class="admin-box">
	...
	<fieldset>
		...
		<div class="control-group <?php echo form_has_error('name') ? 'error' : ''; ?>">
	    	...
	    	<div class="controls">
	    	    <input id="name" type="text" name="name" class="input-large" maxlength="30" value="<?php e(set_value('name', isset($permissions['name']) ? $permissions['name'] : '')); ?>"  />
		...
		<div class="control-group <?php echo form_has_error('description') ? 'error' : ''; ?>">
	        ...
	        <div class="controls">
		        <input id="description" type="text" name="description" maxlength="100" value="<?php e(set_value('description', isset($permissions['description']) ? $permissions['description'] : '')); ?>"  />
