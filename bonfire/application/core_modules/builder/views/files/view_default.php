...
if($action_name != 'create') {
    ...
    <?php if ($this->auth->has_permission(\''.$delete_permission.'\')) : ?>
            ...
            or <button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm(\'<?php echo lang(\''.singular($module_name_lower).'_delete_confirm\'); ?>\')">
...
$view .= PHP_EOL . '
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="'.$action_label.' '.singular($module_name).'"'.$on_click.' />
