		...
		<tbody>
			...
			<tr>
				...
				<td style="width: 15em; text-align: right">
					<a class="btn btn-danger" id="delete-activity_own"><?php echo lang('activity_own_delete'); ?></a>
				</td>
			</tr>
			...
			<tr>
				...
				<td style="width: 15em; text-align: right">
					<a class="btn btn-danger" id="delete-activity_user"><?php echo lang('activity_user_delete'); ?></a>
				</td>
			</tr>
			<?php $empty_table = false; ?>
			<?php endif; ?>
			...
			<tr>
				...
				<td style="width: 15em; text-align: right">
					<a class="btn btn-danger" id="delete-activity_module"><?php echo lang('activity_module_delete'); ?></a>
				</td>
			</tr>
			<?php $empty_table = false; ?>
			<?php endif; ?>
			...
			<tr>
				...
				<td style="width: 15em; text-align: right">
					<a class="btn btn-danger" id="delete-activity_date"><?php echo lang('activity_date_delete'); ?></a>
				</td>
			</tr>
			<?php $empty_table = false; ?>
			<?php endif; ?>
