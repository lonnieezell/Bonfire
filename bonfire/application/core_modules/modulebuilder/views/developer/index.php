...
<div class="view split-view">
	...
	<!-- Role List -->
	<div class="view">
		<h2 class="panel-title"><?php echo lang('mb_modules'); ?></h2>
	...
	<div id="content" class="view">
		<div class="scrollable" id="ajax-content">
				...
				<?php if (isset($modules) && is_array($modules) && count($modules)) : ?>
					...
					<h2><?php echo lang('mb_installed_header'); ?></h2>
					...
					<table>
						...
						<?php foreach ($modules as $module => $config) : ?>
							<tr>
								...
								<td><?php echo anchor(SITE_AREA .'/developer/modulebuilder/delete/'. $config['name'], lang('mb_delete'), 'class="ajaxify"') ?></td>
							</tr>
						<?php endforeach; ?>
						</tbody>
					</table>
