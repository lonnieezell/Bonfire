...
class MY_Form_validation extends CI_Form_validation
{
	...
	{
		$this->CI->form_validation->set_message('unique', lang('bf_form_validation_unique'));
	...
	{
		$this->CI->form_validation->set_message('alpha_extra', lang('bf_form_validation_alpha_extra'));
	...
	function matches_pattern($str, $pattern)
	{
		...
		$this->CI->form_validation->set_message('matches_pattern', lang('bf_form_validation_matches_pattern'));
	...
	public function valid_password($str)
	{
		...
		{
			$this->CI->form_validation->set_message('valid_password',  str_replace('[MIN]', $min_length, lang('bf_form_validation_use_nums')));
			return FALSE;
		}
		...
		if ($use_nums)
		{
			...
			{
				$this->CI->form_validation->set_message('valid_password', lang('bf_form_validation_use_nums'));
				return FALSE;
			}
		}
		...
		if ($use_syms)
		{
			...
			{
				$this->CI->form_validation->set_message('valid_password', lang('bf_form_validation_use_syms'));
				return FALSE;
			}
		}
		...
		if ($use_mixed)
		{
			...
			{
				$this->CI->form_validation->set_message('valid_password', lang('bf_form_validation_use_mixed_upper'));
				return FALSE;
			}

			if (0 === preg_match('/[a-z]/', $str))
			{
				$this->CI->form_validation->set_message('valid_password', lang('bf_form_validation_use_mixed_lower'));
				return FALSE;
			}
		}
	...
	public function allowed_types($str, $types = NULL)
	{
		...
		{
			$this->CI->form_validation->set_message('allowed_types', lang('bf_form_validation_allowed_types'));
			return FALSE;
		}
	...
	public function one_of($str, $options = NULL)
	{
		...
		{
			$this->CI->form_validation->set_message('one_of', lang('bf_form_validation_one_of'));
			return FALSE;
		}
