...
if (! function_exists('gravatar_link')) {
     ...
     * image defaults to the configured 'users.gravatar_default_image' or 'identicon'.
...
if (! function_exists('is_https')) {
     ...
     *
     * @return bool True if the application is currently using HTTPS, else false.
     */
    function is_https()
    {
...
if (! function_exists('log_activity')) {
     ...
     *
     * @return int|bool The ID of the new object, or false on failure (or if enable_activity_logging
     * is not true).
     */
...
if (! function_exists('obj_value')) {
     ...
     *
     * @return null|string If $obj->$key is set, returns the value, or a checked/selected
     * string if $type is 'checkbox', 'radio', or 'select'. Returns null if $obj->$key
     * is not set.
     */
...
if (! function_exists('module_config')) {
     ...
     * @param bool   $return_full If true, will return the entire config array. If false, will return only the 'module_config' portion.
     *
...
if (! function_exists('module_files')) {
     ...
     *
     * @param string $module_name   If not NULL, will return only files from that module.
     * @param string $module_folder If not NULL, will return only files within that folder of each module (ie 'views')
     * @param bool   $exclude_core  Whether we should ignore all core modules.
     *
