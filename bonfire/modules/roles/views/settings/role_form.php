...
<div class="admin-box">
    ...
    <fieldset>
        ...
        <div class="description form-group<?php echo form_error('description') ? ' has-error' : ''; ?>">
            ...
            <span
                class="help-block"><?php echo form_error('description') ? form_error('description') : lang('role_max_desc_length'); ?></span>
        </div>
            ...
            <select name="default_context" id="default_context">
                ...
                if (!empty($contexts) && is_array($contexts)) :
                    foreach ($contexts as $context) :
                        ?>
                        <option
                            value="<?php echo $context; ?>" <?php echo set_select('default_context', $context, isset($role) && $role->default_context == $context); ?>><?php echo ucfirst($context); ?></option>
                        <?php
                    endforeach;
                endif;
                ?>
        ...
        <div class="form-group">
            <label id="can_delete_label"><?php echo lang('role_can_delete_role'); ?></label>
    ...
    <fieldset class="form-actions">
        ...
        if (isset($role)
            ...
            <button type="submit" name="delete" class="btn btn-danger"
                ...
                <span class="icon-trash icon-white"></span>&nbsp;<?php echo lang('role_delete_role'); ?></button>
        <?php endif; ?>
    </fieldset>
    <?php echo form_close(); ?>
</div>