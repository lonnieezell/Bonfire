<fieldset>
    ...
    <div class="form-group<?php echo form_error('title') ? $errorClass : ''; ?>">
        ...
        <div class="controls">
            <input type="text" name="title" id="title" class="col-sm-6 col-lg-4" value="<?php echo set_value('site.title', isset($settings['site.title']) ? $settings['site.title'] : ''); ?>" />
    ...
    <div class="form-group<?php echo form_error('system_email') ? $errorClass : ''; ?>">
        ...
        <div class="controls">
            <input type="text" name="system_email" id="system_email" class="col-sm-4" value="<?php echo set_value('site.system_email', isset($settings['site.system_email']) ? $settings['site.system_email'] : ''); ?>" />
    ...
    <div class="form-group<?php echo form_error('list_limit') ? $errorClass : ''; ?>">
        ...
        <div class="controls">
            <input type="text" name="list_limit" id="list_limit" value="<?php echo set_value('list_limit', isset($settings['site.list_limit']) ? $settings['site.list_limit'] : ''); ?>" class="col-sm-1" />
