	...
	?>
		...
		<fieldset>
            <legend>
                ...
                <button class="gobottom pull-right btn btn-sm"><span class="icon icon-arrow-down"></span></button>
				<?php endif; ?>
                <h3><?php echo lang('tr_translate_file') . ": <span class='filename'>{$lang_file}</span>"; ?></h3>
            </legend>
                ...
                <tfoot>
                    <tr>
                        <td colspan='3'>
                            ...
                            if (count($orig) > 30) :
                            ?>
                            <button class="gotop pull-right btn btn-sm"><span class="icon icon-arrow-up"></span></button>
                            <?php endif; ?>
                        </td>
                    </tr>
                </tfoot>
