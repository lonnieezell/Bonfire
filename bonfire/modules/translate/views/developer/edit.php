	...
	?>
		...
		<fieldset>
            <legend>
                ...
                <button class="gobottom pull-right btn btn-small"><span class="fa fa-arrow-down"></span></button>
				<?php endif; ?>
                ...
                <tfoot>
                    <tr>
                        <td colspan='3'>
                            ...
                            if (count($orig) > 30) :
                            ?>
                            <button class="gotop pull-right btn btn-small"><span class="fa fa-arrow-up"></span></button>
                            <?php endif; ?>
                        </td>
                    </tr>
                </tfoot>
