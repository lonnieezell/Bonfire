...
<div class='container'>
    <div id='login' class='panel panel-default mainbox col-lg-5 col-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-7 col-xs-offset-1'>
        ...
        echo form_open(LOGIN_URL, array('autocomplete' => 'off'));
        ?>
    	...
    	<p style="text-align: center;">
            <?php
            if ( $site_open ) {
                echo anchor(REGISTER_URL, lang('us_sign_up'));
            }
            ?><br/>
