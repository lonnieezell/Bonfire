...
<div class="form-group<?php echo form_error('email') ? $errorClass : ''; ?>">
    ...
    <input class="<?php echo $controlClass; ?>" type="text" id="email" name="email"
...
<div class="form-group<?php echo form_error('pass_confirm') ? $errorClass : ''; ?>">
    <label class="<?php echo $registerClass; ?>"
           for="pass_confirm"><?php echo lang('bf_password_confirm'); ?></label>
...
if (!empty($languages) && is_array($languages)) :
    if (count($languages) == 1) :
        ...
        <div class="form-group<?php echo form_error('language') ? $errorClass : ''; ?>">
            <label class="required" for="language"><?php echo lang('bf_language'); ?></label>

            <select name="language" id="language" class="chzn-select <?php echo $controlClass; ?>">
                <?php foreach ($languages as $language) : ?>
                    <option
                        value="<?php e($language); ?>" <?php echo set_select('language', $language, $defaultLanguage == $language); ?>>
...
<div class="form-group<?php echo form_error('timezones') ? $errorClass : ''; ?>">
    <label class="required" for="timezones"><?php echo lang('bf_timezone'); ?></label>
