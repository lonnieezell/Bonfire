...
<div class='module-builder'>
	...
	<div id="all_fields">
		...
		echo lang('mb_form_fieldname_help');
		    ...
		    $default_max_len = '';
		    if (isset($existing_table_fields[$count]) && $existing_table_fields[$count]['type'] != 'TEXT' && $existing_table_fields[$count]['type'] != 'MEDIUMTEXT' && $existing_table_fields[$count]['type'] != 'LONGTEXT'
		    ) {
