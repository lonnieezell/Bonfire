...
if ($db_required != '') {
    $mb_index .= "
		...
		// Pagination (@author: Lorenzo Sanzari - ulisse73@quipo.it)
...
for ($counter = 1; $field_total >= $counter; $counter++) {
	...
	if ($db_field_type == 'DATE' && $date_included === FALSE) {
	...
	} elseif (($db_field_type == 'TEXT' || $db_field_type == 'MEDIUMTEXT' || $db_field_type == 'LONGTEXT') && $textarea_included === FALSE && !empty($textarea_editor)
	) {
	    // if a date field hasn't been included already then add in the jquery ui files
		 ...
		 */
		/* ElRte editor with integrated ElFinder file manager (@author: Lorenzo Sanzari - www.icomlab.it) */
