	...
	<?php echo form_open($this->uri->uri_string(), ''); ?>
        <fieldset>
            ...
            <div class="form-group<?php echo form_error('name') ? ' error' : ''; ?>">
                ...
                <input id="name" class="form-control" type="text" name="name" class="input-large" maxlength="30" value="<?php echo set_value('name', isset($permissions->name) ? $permissions->name : ''); ?>" />
